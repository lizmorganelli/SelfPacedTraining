...
//describes the class that follows it - decorator (@NgModule()) - manifest for the app - what is the class using
@NgModule({
  imports: [
    BrowserModule,
    FormsModule,
  ...
  declarations: [AppComponent, SectionViewDirective], // what things are in my app
